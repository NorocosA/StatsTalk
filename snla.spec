...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'webview', 'pandas', 'pyreadstat', 'openpyxl', 'lxml',
        ...
        'snla.config', 'snla.secrets', 'snla.session', 'snla.telemetry', 'snla.version',
        'sentry_sdk',
        ...
        'snla.explainer.naturalize', 'snla.explainer.export', 'snla.explainer.record', 'snla.explainer.charts',
